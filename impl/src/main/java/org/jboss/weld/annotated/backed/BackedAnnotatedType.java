...
public class BackedAnnotatedType<X> extends BackedAnnotated implements AnnotatedType<X>
{
   ...
   {
      return new BackedAnnotatedType<X>(originalType.getBaseType(), originalType.getJavaClass(), originalType.getConstructors(), originalType.getMethods(), originalType.getFields());
   }
   ...
   public BackedAnnotatedType(Type baseType, Class<X> javaClass, Set<AnnotatedConstructor<X>> originalConstructors, Set<AnnotatedMethod<? super X>> originalMethods, Set<AnnotatedField<? super X>> originalFields)
   {
      super(baseType);
