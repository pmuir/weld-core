...
public class SuperTypeTest
{
   ...
   {
      return ShrinkWrap.create(BeanArchive.class).addPackage(SuperTypeTest.class.getPackage()).addClass(Utils.class).addServiceProvider(Extension.class, CDIExtension.class);
   }
   ...
   {
      Bean<?> beanTwoBean = beanManager.resolve(beanManager.getBeans(BeanTwo.class, new AnnotationLiteral<Foo>() {}));
